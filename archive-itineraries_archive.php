        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php foreach ( $countries_terms as $country_term ): ?>
                    ...
                    <section class="itinerary section-paddings--both text-center">
            			<div class="row">
            				<div class="col-xs-12">
            					...
            					</div><!-- /.itinerary-gallery -->
            				</div><!-- /.col-xs-12 -->
            			</div><!-- /.row -->
                	</section><!-- /.itinerary section-paddings--both text-center -->
